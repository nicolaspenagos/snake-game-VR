...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""MoveSnake"",
                    ""type"": ""Value"",
                    ""id"": ""c52b12dc-b70f-443a-83e8-d4a8bd43db01"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e6cbce4e-6ff7-4557-94c3-fcf2218f1437"",
                    ""path"": ""<XRController>{LeftHand}/primary2DAxis"",
                    ""interactions"": """",
                    ""processors"": ""StickDeadzone"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandLocomotion_MoveSnake = m_XRILeftHandLocomotion.FindAction("MoveSnake", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHandLocomotion_MoveSnake;
    public struct XRILeftHandLocomotionActions
    {
        ...
        public InputAction @MoveSnake => m_Wrapper.m_XRILeftHandLocomotion_MoveSnake;
        ...
        public void SetCallbacks(IXRILeftHandLocomotionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandLocomotionActionsCallbackInterface != null)
            {
                ...
                @MoveSnake.started -= m_Wrapper.m_XRILeftHandLocomotionActionsCallbackInterface.OnMoveSnake;
                @MoveSnake.performed -= m_Wrapper.m_XRILeftHandLocomotionActionsCallbackInterface.OnMoveSnake;
                @MoveSnake.canceled -= m_Wrapper.m_XRILeftHandLocomotionActionsCallbackInterface.OnMoveSnake;
            }
            ...
            if (instance != null)
            {
                ...
                @MoveSnake.started += instance.OnMoveSnake;
                @MoveSnake.performed += instance.OnMoveSnake;
                @MoveSnake.canceled += instance.OnMoveSnake;
            }
        }
    }
    ...
    public interface IXRILeftHandLocomotionActions
    {
        ...
        void OnMoveSnake(InputAction.CallbackContext context);
    }
